    ...
    public class ParkingService: IParkingService
    {
        ...
        public async Task<ParkingDTO> GetParkingByEstateObjectId(int id)
        {
            ...
            return new ParkingDTO
            {
                ...
                LocalityName = parking.estateObject.Location.Locality.Name,
                DistrictId = parking.estateObject.Location.DistrictId,
                DistrictName = parking.estateObject.Location.District.Name,
