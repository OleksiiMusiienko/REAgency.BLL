    ...
    public class SteadService : ISteadService
    {
        ...
        public async Task<SteadDTO> GetSteadByEstateObjectId(int id)
        {
            ...
            return new SteadDTO
            {
                ...
                LocalityName = stead.estateObject.Location.Locality.Name,
                DistrictId = stead.estateObject.Location.DistrictId,
                DistrictName = stead.estateObject.Location.District.Name,
                ...
                estateObjectId = stead.estateObject.Id
