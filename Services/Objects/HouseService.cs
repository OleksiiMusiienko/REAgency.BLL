    ...
    public class HouseService : IHouseSevice
    {
        ...
        public async Task<HouseDTO> GetHouseByEstateObjectId(int id)
        {
            ...
            return new HouseDTO
            {
                ...
                employeeName = house.estateObject.Employee.Name,
                employeePhone = house.estateObject.Employee.Phone1,
                operationId = house.estateObject.operationId,
                operationName = house.estateObject.Operation.Name,
                locationId = house.estateObject.locationId,

                RegionId = (int)house.estateObject.Location.RegionId,
                RegionName= house.estateObject.Location.Region.Name,
                LocalityId = (int)house.estateObject.Location.LocalityId,
                LocalityName = house.estateObject.Location.Locality.Name,
                DistrictId = (int)house.estateObject.Location.DistrictId,
                DistrictName = house.estateObject.Location.District.Name,
                countryName = house.estateObject.Location.Country.Name,
                ...
                currencyName = house.estateObject.Currency.Name,
                Area = house.estateObject.Area,
                unitAreaId = house.estateObject.unitAreaId,
                areaName = house.estateObject.unitArea.Name,
