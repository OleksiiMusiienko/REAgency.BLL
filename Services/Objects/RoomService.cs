    ...
    public class RoomService: IRoomService
    {
        ...
        public async Task<RoomDTO> GetRoomByEstateObjectId(int id)
        {
            ...
            return new RoomDTO
            {
                ...
                employeeId = room.estateObject.employeeId,
                employeeName = room.estateObject.Employee.Name,
                employeePhone = room.estateObject.Employee.Phone1,
                operationId = room.estateObject.operationId,
                operationName = room.estateObject.Operation.Name,

                locationId = room.estateObject.locationId,
                countryId = room.estateObject.Location.Country.Id,
                countryName = room.estateObject.Location.Country.Name,
                RegionId = room.estateObject.Location.RegionId,
                RegionName = room.estateObject.Location.Region.Name,
                LocalityId = room.estateObject.Location.LocalityId,
                LocalityName = room.estateObject.Location.Locality.Name,
                DistrictId = room.estateObject.Location.DistrictId,
                DistrictName = room.estateObject.Location.District.Name,
                Street = room.estateObject.Street,
                numberStreet = room.estateObject.numberStreet,
                Price = room.estateObject.Price,
                currencyId = room.estateObject.currencyId,
                currencyName = room.estateObject.Currency.Name,
                Area = room.estateObject.Area,
                unitAreaId = room.estateObject.unitAreaId,
                Description = room.estateObject.Description,
                Status = room.estateObject.Status,
                ...
                pathPhoto = room.estateObject.pathPhoto,
                estateType = room.estateObject.estateType,
                estateObjectId = room.estateObject.Id
            };
