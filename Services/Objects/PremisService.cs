    ...
    public class PremisService: IPremisService
    {
        ...
        public async Task<PremisDTO> GetPremisByEstateObjectId(int id)
        {
            ...
            return new PremisDTO
            {
                ...
                employeeName = prem.estateObject.Employee.Name,
                employeePhone = prem.estateObject.Employee.Phone1,
                operationId = prem.estateObject.operationId,
                operationName = prem.estateObject.Operation.Name,

                locationId = prem.estateObject.locationId,
                countryId = prem.estateObject.Location.Country.Id,
                countryName = prem.estateObject.Location.Country.Name,
                RegionId = prem.estateObject.Location.RegionId,
                RegionName = prem.estateObject.Location.Region.Name,
                LocalityId = prem.estateObject.Location.LocalityId,
                LocalityName = prem.estateObject.Location.Locality.Name,
                DistrictId = prem.estateObject.Location.DistrictId,
                DistrictName = prem.estateObject.Location.District.Name,
                ...
                currencyName = prem.estateObject.Currency.Name,
