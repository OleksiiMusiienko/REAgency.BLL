    ...
    public class OfficeService : IOfficeService
    {
        ...
        public async Task<OfficeDTO> GetOfficeByEstateObjectId(int id)
        {
            ...
            return new OfficeDTO
            {
                ...
                LocalityName = office.estateObject.Location.Locality.Name,
                DistrictId = office.estateObject.Location.DistrictId,
                DistrictName = office.estateObject.Location.District.Name,
